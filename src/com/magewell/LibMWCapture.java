...
public class LibMWCapture {
	static {
		try {
			...
			String mwcapturepath=path+"LibMWCapture.dll";
...
/*	public static final int MWCAP_NOTIFY_HDMI_INFOFRAME_AVI				(1ULL << (32 + MWCAP_HDMI_INFOFRAME_ID_AVI))
	...
	public static native MWCAP_VIDEO_CAPTURE_STATUS MWGetVideoCaptureStatus(long hChannel);
	...
	public static native boolean MWCloseEvent(long hEvent);
	...
	public static native long MWCreateD3DRenderer(int nWidth, int nHeight, long dwFourcc, boolean bReverse,boolean bMirror,long hWnd);
